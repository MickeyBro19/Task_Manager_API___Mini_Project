...
public class TaskService {
    ...
    public List<Task> getTaskByUserId(int userId){
        return taskRepo.findByUserUserId(userId);
    }
    public List<Task> getTaskByStatus(String status){
        return taskRepo.findByStatus(status);
    }
    public List<Task> getTaskByUserIdAndStatus(String status,int userId){
        return taskRepo.findByUserUserIdAndStatus(status,userId);
    }
